...
const ImageTextSection: FC<ImageTextSectionProps> = ({
    className,
    title,
    description,
    handle,
            ...
            <div className={`flex items-center justify-center w-full h-full lg:border-r lg:border-primary lg:last:border-r-0 ${className}`}>
                <div className="flex flex-col items-center justify-center text-center w-full">
                    ...
                    <div className="mb-10 lg:mb-30 2xl:mb-30-2xl flex items-baseline">
                        <span className="text-[36px] leading-[48px] lg:text-[58px] lg:leading-[100px] font-normal mr-10 md:mr-20-md 2xl:mr-20-2xl">{count}</span>
